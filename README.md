...
#### Completed projects in the fields of Machine Learning (Python,Seaborn, Scikitlearn, Numpy, Pandas, Matplotlib), Deep Learning (Python, Keras, Knime), Data Analysis (Python, Numpy, Pandas, Matplotlib) and Database Management (MSSQL). 
